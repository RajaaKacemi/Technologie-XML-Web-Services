...
public interface BanqueService {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "listCopmtes", targetNamespace = "http://ws/", className = "proxy.ListCopmtes")
    @ResponseWrapper(localName = "listCopmtesResponse", targetNamespace = "http://ws/", className = "proxy.ListCopmtesResponse")
    @Action(input = "http://ws/BanqueService/listCopmtesRequest", output = "http://ws/BanqueService/listCopmtesResponse")
